const keyCode = [
  ...
  const keyPress = (e) => {
    ...
    if (currentKey === 'Tab') {
      ...
      inputField.setSelectionRange(pos - 1, pos - 1);
    } else if (currentKey === 'CapsLock' || currentKey === 'AltRight' || currentKey === 'AltLeft' || currentKey === 'ShiftLeft' || currentKey === 'ShiftRight' || currentKey === 'ControlLeft' || currentKey === 'ControlRight') {
      inputField.value = `${inputField.value.substring(0, pos)}${inputField.value.substring(pos)}`;
    } else {
